...
<form name="page 1" action="pagee1.php" method="POST">
...
<center>
<input type="submit" class="button" name="submit" value="SUBMIT"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<input type="reset" class="button" value="RESET" name="reset"></center></form> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
<form name="page 1" action="display11.php" method="POST">
<center><input type="submit" class="button" value="DISPLAY" name="display"></center>
</form>
</body>
</html>